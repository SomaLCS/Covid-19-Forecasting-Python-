# -*- coding: utf-8 -*-
"""
Created on Thu Apr  8 10:09:42 2021
...
train_ml=df_per_State_features.iloc[:int(df_per_State_features.shape[0]*0.99)]
valid_ml=df_per_State_features.iloc[int(df_per_State_features.shape[0]*0.99):]

totActiveCases = activecases.values.reshape(-1,1)
trainActiveCases =totActiveCases[0:int(df_per_State_features.shape[0]*0.99)]
validActiveCases=totActiveCases[int(df_per_State_features.shape[0]*0.99):]

train_dates = df_per_State_features['Date'].iloc[:int(df_per_State_sel_features.shape[0]*0.99)].values
valid_dates = df_per_State_features['Date'].iloc[int(df_per_State_sel_features.shape[0]*0.99):].values
